...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "dspace_community.db";
    ...
    private static final String DATABASE_CREATE = "create table "
            + TABLE_COMMUNITY + "(" + COLUMN_ID
            + " integer primary key autoincrement , " + COLUMN_TITLE
            + " text not null, " + COLUMN_PARENT_ID
            + " text not null, " + COLUMN_DSPACE_ID
            + " text not null, " + COLUMN_LEVEL
            + " text not null, " + COLUMN_LFT
            + " text not null, " + COLUMN_RGT
            + " text not null, " + COLUMN_IMAGEURL
            + " text not null)";

    private static final String DATABASE_CREATE1 = "create table "
            + TABLE_CHILD_COMMUNITY + "(" + COLUMN_ID
            + " integer primary key autoincrement , " + COLUMN_TITLE
            + " text not null, " + COLUMN_PARENT_ID
            + " text not null, " + COLUMN_DSPACE_ID
            + " text not null, " + COLUMN_LEVEL
